...
public class MyLocationsFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeLayout = (SwipeRefreshLayout) v.findViewById(R.id.my_locations);
    ...
    private void refreshList(){
        ...
        if (coordinates.size() > 0) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.rowmessage, R.id.label, values);
